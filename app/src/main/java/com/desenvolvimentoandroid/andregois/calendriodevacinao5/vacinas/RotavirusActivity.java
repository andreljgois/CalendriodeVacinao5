...
public class RotavirusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Rotavírus");     //Titulo para ser exibido na sua Action Bar em frente à seta
    }
