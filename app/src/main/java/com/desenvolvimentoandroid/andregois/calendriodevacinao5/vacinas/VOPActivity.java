...
public class VOPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("VOP - Poliomielite Oral");     //Titulo para ser exibido na sua Action Bar em frente à seta
    }
